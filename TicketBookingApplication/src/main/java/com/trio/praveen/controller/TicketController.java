...
public class TicketController
{
	...
	//Output will be convert to JSON ...i.e.. Iterable<Ticket> will be converted into  JSON Format
	...
	*/
	...
	@PutMapping(value="/{ticketId}/{email}") //http:localhost:8080/tickets/1/pk@gmail.com
	public Ticket updateTicket(@PathVariable("ticketId") Integer ticketId, @PathVariable("email") String newEmail)
	{
